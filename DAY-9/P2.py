...
#find the max digit from the code which is less or equal to the length of string and put that place char in final string,
...
#output:kueX
s=input()#input:Abhishek:43848,Mayur:3749,Friend:3949,yeah:7878
op=''
los=s.split(',')
for i in los:
    nc=i.split(':')
